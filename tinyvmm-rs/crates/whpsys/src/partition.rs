...
use windows_sys::Win32::System::Hypervisor::{
    WHvCreatePartition, WHvDeletePartition, WHvSetPartitionProperty, WHvSetupPartition,
    ...
    WHvPartitionPropertyCodeProcessorCount, WHV_PARTITION_HANDLE, WHV_PARTITION_PROPERTY_CODE,
...
impl Partition {
    pub fn new(vcpu_count: u32) -> Result<Self> {
        ...
        check_hr(unsafe { WHvCreatePartition(&mut handle) }, "WHvCreatePartition")?;
        let p = Partition { handle, vcpu_count, setup_done: false };
    ...
    pub fn setup(&mut self) -> Result<()> {
        ...
        check_hr(unsafe { WHvSetupPartition(self.handle) }, "WHvSetupPartition")?;
