...
use windows_sys::Win32::System::Hypervisor::{
    WHvMapGpaRange, WHvUnmapGpaRange, WHvMapGpaRangeFlagExecute, WHvMapGpaRangeFlagRead,
    WHvMapGpaRangeFlagWrite, WHV_PARTITION_HANDLE,
};
use windows_sys::Win32::System::Memory::{
    VirtualAlloc, VirtualFree, MEM_COMMIT, MEM_LARGE_PAGES, MEM_RELEASE, MEM_RESERVE, PAGE_READWRITE,
};
...
impl GuestMemory {
    pub fn new(
        ...
        let hr = unsafe {
            WHvMapGpaRange(part, base as *const c_void, gpa, alloc_size as u64, flags)
        };
